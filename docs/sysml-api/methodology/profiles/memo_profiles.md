...
| Source | [`src/methodology/profiles/memo_profiles.sysml`](https://github.com/memoarchitect/memo/blob/main/src/methodology/profiles/memo_profiles.sysml) |

## Namespace hierarchy

`memo` → `memo::methodology` → `memo::methodology::profiles`
...
??? code "methodology/profiles/memo_profiles.sysml"
