...
| Declared package | `memo_architecture_deployment` |
...
| private | `memo_architecture_software_runtime::*` |
| private | `memo_architecture_physical::*` |
...
| Owning package | `memo_architecture_deployment` |
