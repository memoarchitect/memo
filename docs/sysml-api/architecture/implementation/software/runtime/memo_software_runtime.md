...
# memo_architecture_software_runtime
...
| Declared package | `memo_architecture_software_runtime` |
...
| private | `memo_architecture_software_structure::*` |
...
| Abstract | No |
| Specializes | — |
| Owning package | `memo_architecture_software_runtime` |
