...
| [`PropertySet`](architecture/functional/behavior/memo_behavior.md#propertyset) | `part def` | Property set definition specializing `VerifiableElement`. | [`architecture/functional/behavior/memo_behavior.sysml`](architecture/functional/behavior/memo_behavior.md) |
